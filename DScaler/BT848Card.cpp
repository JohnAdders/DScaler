...
INT_PTR CALLBACK CBT848Card::ChipSettingProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
...
INT_PTR CALLBACK CBT848Card::RegisterEditProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
