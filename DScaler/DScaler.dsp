...
# ADD CPP /nologo /G6 /MTd /W3 /GR /GX /ZI /Od /Op /I "..\api" /I ".\\" /D "_DEBUG" /D "_WINDOWS" /D "WIN32" /D "_MBCS" /D "_WIN32_DCOM" /D "TIXML_USE_STL" /D "WANT_CX2388X_SUPPORT" /D "WANT_DSHOW_SUPPORT" /D "WANT_SAA713X_SUPPORT" /D "WANT_BT8X8_SUPPORT" /FR /Yu"stdafx.h" /FD /c
...
# ADD LINK32 GDI32.lib User32.lib Kernel32.lib shell32.lib Comdlg32.lib ddraw.lib dxguid.lib winmm.lib COMCTL32.LIB version.lib htmlhelp.lib vfw32.lib strmiids.lib quartz.lib setupapi.lib shlwapi.lib /nologo /stack:0x4000,0x4000 /subsystem:windows /pdb:"..\Debug/DScaler.pdb" /map:"..\Debug/DScaler.map" /debug /debugtype:cv /machine:I386 /out:"..\Debug\DScaler.exe" /libpath:"..\ThirdParty\LibTiff\\" /libpath:"..\ThirdParty\LibJpeg\\"
...
# ADD CPP /nologo /G6 /MT /W3 /Gi /GR /GX /Zi /Ot /Ow /Oi /Op /Ob1 /Gf /Gy /I "..\api" /I ".\\" /D "NDEBUG" /D "_WINDOWS" /D "WIN32" /D "_MBCS" /D "_WIN32_DCOM" /D "TIXML_USE_STL" /D "WANT_CX2388X_SUPPORT" /D "WANT_DSHOW_SUPPORT" /D "WANT_SAA713X_SUPPORT" /D "WANT_BT8X8_SUPPORT" /FAcs /FR /Yu"stdafx.h" /FD /c
# SUBTRACT CPP /Ox /Og
...
# ADD LINK32 COMMODE.OBJ d3d9.lib shlwapi.lib GDI32.lib User32.lib Kernel32.lib shell32.lib Comdlg32.lib ddraw.lib dxguid.lib winmm.lib COMCTL32.LIB version.lib htmlhelp.lib vfw32.lib strmiids.lib quartz.lib setupapi.lib /nologo /subsystem:windows /pdb:"..\Release/DScaler.pdb" /map:"..\Release/DScaler.map" /debug /machine:I386 /out:"..\Release\DScaler.exe" /libpath:"..\ThirdParty\LibTiff\\" /libpath:"..\ThirdParty\LibJpeg\\"
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
ProjDir=.
SOURCE="$(InputPath)"
