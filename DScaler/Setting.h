/////////////////////////////////////////////////////////////////////////////
// $Id: Setting.h,v 1.12 2002-09-28 13:34:07 kooiman Exp $
/////////////////////////////////////////////////////////////////////////////
...
{
public:
    CSettingGroup(LPCSTR szGroupName, LPCSTR szLongName, LPCSTR szInfoText = NULL, int Info = 0, void *pObject = NULL);
    ~CSettingGroup();
...
public:    
    ...
    CSettingGroup *Get(void *pObject, char **pszGroupList, char **pszDisplayNameList = NULL, char **pszTooltip = NULL);			
	CSettingGroup *GetGroup(void *pObject, LPCSTR szGroupName, LPCSTR szDisplayName = NULL, LPCSTR szTooltip = NULL);
...
#define DEFINE_YESNO_CALLBACK_SETTING(Class, Name) \
    ...
    { \
    public: \
        C ## Name ## Setting(const Class* Parent, LPCSTR DisplayName, BOOL Default, LPCSTR Section, CSettingGroup *pGroup = NULL, eSettingFlags SettingFlags = (eSettingFlags)(SETTINGFLAG_GLOBAL|SETTINGFLAG_ONCHANGE_ALL), long GUIinfo = 0) : \
...
#define DEFINE_SLIDER_CALLBACK_SETTING(Class, Name) \
    ...
    { \
    public: \
        C ## Name ## Setting(const Class* Parent, LPCSTR DisplayName, long Default, long Min, long Max, LPCSTR Section, CSettingGroup *pGroup = NULL, eSettingFlags SettingFlags = (eSettingFlags)(SETTINGFLAG_GLOBAL|SETTINGFLAG_ONCHANGE_ALL), long GUIinfo = 0) : \
...
#define DEFINE_LIST_CALLBACK_SETTING(Class, Name) \
    ...
    { \
    public: \
        C ## Name ## Setting(const Class* Parent, LPCSTR DisplayName, long Default, long Max, LPCSTR Section, const char** pszList, CSettingGroup *pGroup = NULL, eSettingFlags SettingFlags = (eSettingFlags)(SETTINGFLAG_GLOBAL|SETTINGFLAG_ONCHANGE_ALL), long GUIinfo = 0) : \
