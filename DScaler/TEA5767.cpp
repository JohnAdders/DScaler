/////////////////////////////////////////////////////////////////////////////
// $Id: TEA5767.cpp,v 1.1 2005-01-13 19:44:17 to_see Exp $
/////////////////////////////////////////////////////////////////////////////
//
...
{
	BYTE buffer[5] = { 0xff, 0xff, 0xff, 0xff, 0xff };
	...
	LOG(1, "TEA5767: Not Found. 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X",
		buffer[0], buffer[1], buffer[2], buffer[3], buffer[4]);
	return FALSE;
}
