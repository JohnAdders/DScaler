/////////////////////////////////////////////////////////////////////////////
// $Id: VTCharacterSet.cpp,v 1.4 2003-10-27 10:39:54 adcockj Exp $
/////////////////////////////////////////////////////////////////////////////
...
//                                     VTConvTables.cpp into this new file.
...
/**
 * @file VTCharacterSet.cpp CVTCharacterSet Implementation
 */
...
CVTCharacterSet::TCharacterSetDesignation
    CVTCharacterSet::m_CharacterSetDesignation[VTCODEPAGE_LASTONE] =
{
...
WORD CVTCharacterSet::m_G0CharacterSet[VTG0CHARACTERSET_LASTONE][96] =
{
...
WORD CVTCharacterSet::VTCharToUnicode(eVTCodepage VTCodepage, BYTE VTChar)
{
    if (VTChar < 0x20)
    {
        return 0x0020;
    ...
    eG0CharacterSet G0CharacterSet = m_CharacterSetDesignation[VTCodepage].G0CharacterSet;
    ...
    if (G0CharacterSet == VTG0CHARACTERSET_LATIN)
    {
        switch (VTChar)
        {
        case 0x23: Unicode = m_G0LatinSubset[G0LatinSubset][0]; break;
        case 0x24: Unicode = m_G0LatinSubset[G0LatinSubset][1]; break;
        case 0x40: Unicode = m_G0LatinSubset[G0LatinSubset][2]; break;
        case 0x5B: Unicode = m_G0LatinSubset[G0LatinSubset][3]; break;
        case 0x5C: Unicode = m_G0LatinSubset[G0LatinSubset][4]; break;
        case 0x5D: Unicode = m_G0LatinSubset[G0LatinSubset][5]; break;
        case 0x5E: Unicode = m_G0LatinSubset[G0LatinSubset][6]; break;
        case 0x5F: Unicode = m_G0LatinSubset[G0LatinSubset][7]; break;
        case 0x60: Unicode = m_G0LatinSubset[G0LatinSubset][8]; break;
        case 0x7B: Unicode = m_G0LatinSubset[G0LatinSubset][9]; break;
        case 0x7C: Unicode = m_G0LatinSubset[G0LatinSubset][10]; break;
        case 0x7D: Unicode = m_G0LatinSubset[G0LatinSubset][11]; break;
        case 0x7E: Unicode = m_G0LatinSubset[G0LatinSubset][12]; break;
        default:
            Unicode = m_G0CharacterSet[VTG0CHARACTERSET_LATIN][VTChar - 0x20];
            break;
        }
    }
    else
    {
        Unicode = m_G0CharacterSet[G0CharacterSet][VTChar - 0x20];
    }
...
void CVTCharacterSet::GetCharacterSet(eVTCodepage VTCodepage, WORD pBuffer[96])
{
    eG0CharacterSet G0CharacterSet = m_CharacterSetDesignation[VTCodepage].G0CharacterSet;

    CopyMemory(pBuffer, m_G0CharacterSet[G0CharacterSet], sizeof(WORD) * 96);
