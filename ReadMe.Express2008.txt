Compilation instructions for Visual Studio 2008 C++ Express
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

1. Unpack the DScaler source code into any subdirectory

2. Install the windows SDK from
...
4. Get the Windows Server 2003 DDK from
   http://www.microsoft.com/whdc/DevTools/ddk/default.mspx

5. Patch up the ATL files
...
7. Open DScaler\DScaler2008.sln in Visual Studio. Go to Solution Explorer, right click on 'DScaler' in tree view, select 'Set as StartUp Project'.
